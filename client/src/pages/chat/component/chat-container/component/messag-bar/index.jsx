...
const MessageBar = () => {
  ...
  return (
    <div className="h-[10vh] bg-[#1c1d25] flex justify-center items-center px-4 md:px-8 mb-6 gap-4 md:gap-6">
      <div className="flex-1 flex bg-[#2a2b33] rounded-md items-center gap-1 pr-5">
        <input
      ...
      <button
        ...
        className="bg-[#8417ff] rounded-md items-center justify-center p-5 hover:bg-[#741bda] focus:[#741bda] focus:outline-none focus:text-white duration-300 transition-all"
